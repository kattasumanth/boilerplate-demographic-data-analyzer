...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = round((higher_ed[higher_ed['salary'] == '>50K'].shape[0]/higher_ed.shape[0]) * 100, 1)
    lower_education_rich = round((lower_ed[lower_ed['salary'] == '>50K'].shape[0]/lower_ed.shape[0]) * 100, 1)
    ...
    wealth_percentages = round((df['native-country'][df['salary'] == '>50K'].value_counts()/ df['native-country'].value_counts()) * 100, 1)

    highest_earning_country = wealth_percentages.idxmax()
    highest_earning_country_percentage = wealth_percentages.max()
